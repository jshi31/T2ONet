from .bilinearGAN_base_options import BaseOptions
...
class TrainOptions(BaseOptions):
    ...
    def __init__(self):
        ...
        # Training
        self.parser.add_argument('--resume', default=0, type=int, help='if resume training')
        ...
        self.parser.add_argument('--learning_rate', default=2e-4, type=float, help='learning rate')
        self.parser.add_argument('--lr_decay', default=0.5, type=float, help='learning rate decay')
        self.parser.add_argument('--momentum', default=0.5, type=float, help='momentum')
